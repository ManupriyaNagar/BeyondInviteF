...
export default function EInvitations() {
  ...
  useEffect(() => {
    const fetchGeneralInvitations = async () => {
      try {
        ...
        // ✅ Filter general invitations (exclude wedding, corporate, baby shower etc.)
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header Section */}
      <div className="bg-indigo-50 py-12 border-b sticky top-0 h-fit self-start z-10">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">E-Invitations</h1>
          <p className="text-gray-600 max-w-3xl">
            ...
            birthdays, corporate events, festivals, and more.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <main className="md:col-span-3">
          {/* Filter Bar */}
          <div className="sticky top-49 h-fit self-start z-10 bg-white">
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <span className="text-lg font-bold text-indigo-600">₹{card.price || "N/A"}</span>
          ...
          {invitations.length === 0 && (
            <p className="text-gray-600 mt-10 text-center">No E-Invitations found.</p>
          )}
        </main>
      </div>
    </div>
